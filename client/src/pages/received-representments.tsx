...
export default function ReceivedRepresentments() {
  ...
  const handleExport = () => {
    console.log("Export received representments");
  };
  ...
  return (
    <div className="flex-1 overflow-auto">
      <Header
        ...
        subtitle="Manage and analyze received representment cases"
          ...
          <div className="p-6 border-b border-banking-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <ArrowDown className="w-5 h-5 text-banking-indicator" />
                <h3 className="text-lg font-semibold text-banking-text">Received Representments</h3>
              </div>
                ...
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={8} className="px-6 py-8 text-center text-banking-text/60">
                      No received representments found
                    </td>
                  </tr>
                )}
              </tbody>
