...
export default function ReceivedChargebacks() {
  ...
  const displayData = filteredData.length > 0 ? filteredData : (chargebacks || []);

  return (
    <div className="p-6 space-y-6">
      <Header 
        title="Received Chargebacks" 
        subtitle="Track and manage incoming chargeback cases"
        ...
        <Card className="bg-banking-primary border border-banking-gray-200">
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              <ArrowDown className="w-4 h-4 text-banking-error" />
              <div>
        ...
        <CardContent className="p-0">
          ...
          {!isLoading && displayData.length === 0 && (
            <div className="text-center py-12">
              <p className="text-banking-text/70">No received chargebacks found</p>
            </div>
          )}
        </CardContent>
      </Card>
